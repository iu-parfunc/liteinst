...
benchmark_names = ["h264ref-9.3", "fluid", "blackscholes", "hull", "nbody","bzip-1.0.3", "perl-5.8.7", "hmmer", "sjeng"]


main :: IO ()
main = do
  putStrLn "Begin LITEPROF benchmarks..."
  defaultMainModifyConfig $ \conf ->
    conf { benchlist = benches
         , runTimeOut = Just 600
         , plugIns = [SomePlugin defaultDribblePlugin ]
         , harvesters = customTagHarvesterInt "FUNCS" `mappend`
                        customTagHarvesterInt "SKIPPED_FUNCS" `mappend`
                        customTagHarvesterInt "FAILED_FUNCS"  `mappend`
                        customTagHarvesterInt "PROBESITES"    `mappend`
                        customTagHarvesterInt "FAILED_PROBESITES" `mappend`
                        customTagHarvesterInt "SKIPPED_PROBESITES" `mappend`
                        customTagHarvesterInt "FIXED_ALLOCATIONS"  `mappend`
                        customTagHarvesterInt "FIXED_PAGES"        `mappend`
                        customTagHarvesterInt "FIXED_ALLOCATED"    `mappend`
                        customTagHarvesterDouble "FIXED_UTILIZATION" `mappend`
                        customTagHarvesterInt "ARENA_ALLOCATIONS" `mappend`
                        customTagHarvesterInt "ARENA_PAGES"       `mappend`
                        customTagHarvesterInt "ARENA_ALLOCATED"   `mappend`
...
benches =
  ...
  where
    variants =  [("liteprof",setVariant),("noprof",setVariant)]
