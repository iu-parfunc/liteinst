...
int main (int argc, const char* argv[]) {
   ...
   */
    ...
    ticks insertion_cost = total / n_funcs;
    ...
    ticks deletion_cost = total / n_funcs;
    ...
    */
    ...
    ticks resuming_cost = end - start;
    printf("COST_RESUMING : %ld\n", end - start);

    fp = fopen("dyninst.out", "a");
    fprintf(fp, "%ld, %ld, %ld, %ld\n", attach_cost,  insertion_cost, 
        deletion_cost, resuming_cost);
    fflush(fp);
    fclose(fp);
