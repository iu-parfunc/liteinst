...
// Details : Sigtrap signal handler enters an infinite loop.
// Result  : Only the interrupted thread gets stopped. It will not not execute
//           further since the interrupt handler never returns.
